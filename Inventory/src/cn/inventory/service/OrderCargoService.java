...
public interface OrderCargoService {
	/**
	 * 入库退货先给进货订单改为退货订单
	...
	/**
	 * 供应商往来账-根据条件查询供应商往来账列表
	 * @param orderCargoName 商品名称
	 * @param isOrderCargoPayment 是否付款
	 * @return
	 */
	public  List<OrderCargo> getSupplierList(String orderCargoName,Integer isOrderCargoPayment);
	
	/**
	 * 供应商往来账-根据条件查询供应商往来账记录数
	 * @param orderCargoName 商品名称
	 * @param isOrderCargoPayment 是否付款
	 * @return
	 */
	public int getSupplierCount(String orderCargoName,Integer isOrderCargoPayment);
