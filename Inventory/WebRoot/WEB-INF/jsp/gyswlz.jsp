				...
				<div class="page-teb">
					<div class="l-tab-links">
						<ul style="left:0;">
							...
							<li class="l-select"><a href="${pageContext.request.contextPath }/User/index.html">供应商往来账</a>
										...
										<div class="grid">
											<div class="layoutitem" style="width:100%;border:none;">
												...
												<div style="display: inline-flex;margin:5px 0 20px 0;">
													<div
														style="width: 300px;margin: 0 20pxh;eight: 60px; " class="bg-deep">
												...
												<form
													action="${pageContext.request.contextPath }/orderCargo/gyswlz.html"
													method="get"
													style="text-align: center;font-size: 20px;margin:10px 0px;">
													<span>商品名称：</span> <input name="queryProductName"
														type="text" value="${queryProductName }"> <span>是否付款：</span>
													...
													<thead>
														...
														<c:forEach var="olist" items="${pageInfo.list}"
															...
															<tr>
																...
																<td>${olist.orderCargoCode}</td>
																<td>${olist.orderCargoName }</td>
																<td>${olist.orderCargoUnitPrice }</td>
																<td>${olist.orderCargoNumber }</td>

																<td>${olist.orderCargoTotalPrice }</td>

																<td>${olist.supplierName }</td>
																<td><c:if test="${olist.isOrderRefundCargo==0 }">未退货订单</c:if>
																	<c:if test="${olist.isOrderRefundCargo==1 }">退货订单</c:if>
																</td>
															</tr>
														</c:forEach>
													</thead>
											...
											<ul class="pager">
												...
												<li><a
													href="${pageContext.request.contextPath }/orderCargo/gyswlz.html?pageNo=${pageInfo.firstPage}">首页</a>
												</li>
												<c:choose>
													...
													<c:otherwise>
														<li class=""><a
															href="${pageContext.request.contextPath }/orderCargo/gyswlz.html?pageNo=${pageInfo.pageNum-1}">
																上一页</a></li>
														</li>
													</c:otherwise>
												</c:choose>
												<c:choose>
													...
													<c:otherwise>
														<li><a
															href="${pageContext.request.contextPath }/orderCargo/gyswlz.html?pageNo=${pageInfo.pageNum+1}">下一页
														</a>
														</li>
													</c:otherwise>
												</c:choose>
												<li><a
													href="${pageContext.request.contextPath }/orderCargo/gyswlz.html?pageNo=${pageInfo.lastPage}">尾页</a>
												</li>
											</ul>
										</div>
									</div>
