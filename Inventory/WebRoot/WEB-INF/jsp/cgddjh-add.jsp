...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/cgddjh-add.js"></script>
</head>
				...
				<div class="page-teb">
					<div class="l-tab-links">
						<ul style="left:0;">
							...
							<li class="l-select" id="click"><a href="${pageContext.request.contextPath }/User/index.html">采购订单计划</a>
					...
					<div class="l-tab-content">
						<form
							action="${pageContext.request.contextPath }/orderPlan/insertOrder.html"
										...
										<td align="left" valign="top"
											...
											<div class="formcontentsize" style="width:auto;height:auto;">
												...
												<div class="layoutitem">
													<div class="layout-tit">采购订单计划</div>
													<div class="layout-xx">
														<ul>
															<li>
															...
															<li>
																<div class="item-input">
																	<label class="item-label">商品单位</label> <input
																		...
																		id="orderPlanUnit" name="orderPlanUnit" />*
																</div>
																<div class="item-input">
